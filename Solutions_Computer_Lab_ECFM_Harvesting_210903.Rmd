...
a) As the population increases in numbers, the contribution of each individual to the population growth rate declines. The decline is linear with an intercept $r$ and slope $r/K$. The expression $(1-N/K)$ reaches $0$ when $N$ approaches $K$, and at really low $N$, the population grows exponentially (proportional to $N$). 
